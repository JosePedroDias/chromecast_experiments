// PATCHED //www.gstatic.com/cv/js/sender/v1/cast_sender.js
...
(function() {
    ...
    chrome.cast.ApiBootstrap_.isExtensionInstalled_ = function(extensionId, callback) {
        ...
        xmlhttp.open("GET", chrome.cast.ApiBootstrap_.getCastSenderUrl_(extensionId), /*!0*/ false); // TODO NOW SYNCHRONOUS
        xmlhttp.send();
    };

    chrome.cast.ApiBootstrap_.findInstalledExtension_(function(extensionId) {
        if (extensionId) {
            chrome.cast.exists = true; // TODO NEW
